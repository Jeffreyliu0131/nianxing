...
function normalizeTask(value) {
  ...
  const scheduledAt = value?.scheduledAt === null ? null : safeIso(value?.scheduledAt);
  ...
  const duration = typeof value?.durationMinutes === "number" ? value?.durationMinutes : Number.NaN;
  return {
    id,
    title,
    scheduledAt,
